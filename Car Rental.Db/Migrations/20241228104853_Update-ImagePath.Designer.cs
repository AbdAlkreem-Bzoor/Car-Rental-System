...
namespace Car_Rental.Db.Migrations
{
    ...
    [Migration("20241228104853_Update-ImagePath")]
            ...
            modelBuilder.Entity("Car_Rental.Db.Entities.Rental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CarId = 1,
                            EndDate = new DateTime(2025, 1, 4, 12, 48, 52, 320, DateTimeKind.Local).AddTicks(8550),
                            StartDate = new DateTime(2024, 12, 29, 12, 48, 52, 318, DateTimeKind.Local).AddTicks(5146),
                            Status = "Pending",
                            TotalAmount = 350m,
                            UserId = 1
                        },
                        new
                        {
                            Id = 2,
                            CarId = 2,
                            EndDate = new DateTime(2025, 1, 2, 12, 48, 52, 320, DateTimeKind.Local).AddTicks(9320),
                            StartDate = new DateTime(2024, 12, 30, 12, 48, 52, 320, DateTimeKind.Local).AddTicks(9311),
                            Status = "Confirmed",
                            TotalAmount = 225m,
                            UserId = 2
                        },
                        new
                        {
                            Id = 3,
                            CarId = 3,
                            EndDate = new DateTime(2025, 1, 7, 12, 48, 52, 320, DateTimeKind.Local).AddTicks(9324),
                            StartDate = new DateTime(2024, 12, 31, 12, 48, 52, 320, DateTimeKind.Local).AddTicks(9323),
                            Status = "Active",
                            TotalAmount = 750m,
                            UserId = 3
                        });
